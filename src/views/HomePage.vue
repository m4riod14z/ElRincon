    ...
    <ion-content fullscreen class="home-content ion-padding">
      <div class="wrap">
        <div class="card">
          ...
          <ion-button expand="block" size="large" class="btn-google" @click="onGoogle">
            <span class="g-icon" aria-hidden="true" v-html="googleSvg"></span>
            <span>Continuar con Google</span>
          </ion-button>

          <ion-button expand="block" size="large" fill="outline" class="btn-email" @click="toggleEmail">
          ...
          <ion-card v-if="showEmailOptions" class="email-card">
            <ion-card-content>
              <div class="email-actions">
                <ion-button expand="block" color="medium" fill="solid" @click="onLogin">
                  Ingresar
                </ion-button>
                <ion-button expand="block" color="tertiary" fill="solid" @click="onRegister">
                  Registrarse
                </ion-button>
              </div>
            </ion-card-content>
...
/* Ícono Google SVG inline (para que se vea igual en todas partes) */
...
<style scoped>
/* Fondo general acorde a app de comida rápida (degradado suave) */
.home-content {
  --padding-start: 0;
  --padding-end: 0;
...
.btn-email { /* outline ya definido por ionic; afinamos bordes */
  --border-radius: 14px;
}

/* Ícono Google alineado */
.g-icon {
  display: inline-grid;
  place-items: center;
  margin-right: 10px;
